...
git clone --single-branch -b ${latest_release} https://github.com/openwrt/openwrt openwrt_release --depth=1
git clone --single-branch -b openwrt-21.02 https://github.com/openwrt/openwrt openwrt --depth=1
